 ...
 * @generated
 */
public class MicroservicesArchitectureDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public MicroservicesArchitectureDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MicroservicesArchitecture.diagram.navigator.MicroservicesArchitectureDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((MicroservicesArchitecture.diagram.navigator.MicroservicesArchitectureDomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MicroservicesArchitecture.diagram.navigator.MicroservicesArchitectureDomainNavigatorItem(
