 ...
 * @generated
 */
public class InterfaceEndPoint2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InterfaceEndPoint2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MicroservicesArchitecture.diagram.providers.MicroservicesArchitectureParserProvider.getParser(
					...
					MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry.getType(
							MicroservicesArchitecture.diagram.edit.parts.InterfaceEndPoint2EditPart.VISUAL_ID));
		}
		return parser;
	}
