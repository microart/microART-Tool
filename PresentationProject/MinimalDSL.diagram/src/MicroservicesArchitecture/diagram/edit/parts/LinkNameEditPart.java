...
public class LinkNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry
				.getType(MicroservicesArchitecture.diagram.edit.parts.LinkNameEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MicroservicesArchitecture.diagram.edit.policies.MicroservicesArchitectureTextSelectionEditPolicy());
		...
		if (parser == null) {
			parser = MicroservicesArchitecture.diagram.providers.MicroservicesArchitectureParserProvider.getParser(
					...
					getParserElement(), MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry
							.getType(MicroservicesArchitecture.diagram.edit.parts.LinkNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					MicroservicesArchitecture.diagram.edit.parts.MicroservicesArchitectureEditPartFactory
