...
public class Interface2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MicroservicesArchitecture.diagram.edit.policies.Interface2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MicroservicesArchitecture.diagram.edit.parts.InterfaceEndPoint2EditPart) {
			((MicroservicesArchitecture.diagram.edit.parts.InterfaceEndPoint2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureInterfaceLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 104, 199, 246);
