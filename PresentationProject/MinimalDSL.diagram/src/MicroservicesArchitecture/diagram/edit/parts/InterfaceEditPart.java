...
public class InterfaceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MicroservicesArchitecture.diagram.edit.policies.InterfaceItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MicroservicesArchitecture.diagram.edit.parts.InterfaceEndPointEditPart) {
			((MicroservicesArchitecture.diagram.edit.parts.InterfaceEndPointEditPart) childEditPart)
