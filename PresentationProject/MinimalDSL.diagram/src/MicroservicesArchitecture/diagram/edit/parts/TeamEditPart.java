...
public class TeamEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MicroservicesArchitecture.diagram.edit.policies.TeamItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MicroservicesArchitecture.diagram.edit.parts.TeamNameEditPart) {
			((MicroservicesArchitecture.diagram.edit.parts.TeamNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureTeamLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class TeamFigure extends Ellipse {
