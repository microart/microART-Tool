	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry.getVisualID(
					outgoingLink) == MicroservicesArchitecture.diagram.edit.parts.MicroServiceOwnedEditPart.VISUAL_ID) {
					...
					case MicroservicesArchitecture.diagram.edit.parts.InterfaceEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry
									.getVisualID(
											incomingLink) == MicroservicesArchitecture.diagram.edit.parts.LinkEditPart.VISUAL_ID) {
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry
									.getVisualID(
											outgoingLink) == MicroservicesArchitecture.diagram.edit.parts.LinkEditPart.VISUAL_ID) {
