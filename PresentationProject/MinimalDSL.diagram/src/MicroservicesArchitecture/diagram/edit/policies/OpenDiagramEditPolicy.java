	...
	private static class OpenDiagramCommand extends AbstractTransactionalCommand {
		...
		*/
		OpenDiagramCommand(HintedDiagramLinkStyle linkStyle) {
			...
			super(TransactionUtil.getEditingDomain(linkStyle),
					MicroservicesArchitecture.diagram.part.Messages.CommandName_OpenDiagram, null);
		...
		*/
		protected String getDiagramKind() {
			return MicroservicesArchitecture.diagram.edit.parts.ProductEditPart.MODEL_ID;
		}
