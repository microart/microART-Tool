 ...
 * @generated
 */
public class MicroServiceMicroServiceExposeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return MicroservicesArchitecture.MicroservicesArchitecturePackage.eINSTANCE.getMicroService_Expose();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor> childDescriptors = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramUpdater
				.getMicroServiceMicroServiceExposeCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return MicroservicesArchitecture.diagram.edit.parts.InterfaceEditPart.VISUAL_ID == MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor> childDescriptors = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramUpdater
				.getMicroServiceMicroServiceExposeCompartment_7001SemanticChildren((View) getHost().getModel());
