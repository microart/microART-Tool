 ...
 * @generated
 */
public class MicroServiceCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize
					.add(MicroservicesArchitecture.MicroservicesArchitecturePackage.eINSTANCE.getMicroService_Expose());
			myFeaturesToSynchronize.add(
					MicroservicesArchitecture.MicroservicesArchitecturePackage.eINSTANCE.getMicroService_Require());
		}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor> childDescriptors = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramUpdater
				.getMicroService_2001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		int visualID = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry
				.getVisualID(view);
		return visualID == MicroservicesArchitecture.diagram.edit.parts.InterfaceEditPart.VISUAL_ID
				|| visualID == MicroservicesArchitecture.diagram.edit.parts.Interface2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor> childDescriptors = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramUpdater
				.getMicroService_2001SemanticChildren((View) getHost().getModel());
		...
		HashMap<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor, LinkedList<View>> potentialViews = new HashMap<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor, LinkedList<View>>();
		//
