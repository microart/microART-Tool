 ...
 * @generated
 */
public class MicroServiceMicroServiceRequireCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return MicroservicesArchitecture.MicroservicesArchitecturePackage.eINSTANCE.getMicroService_Require();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor> childDescriptors = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramUpdater
				.getMicroServiceMicroServiceRequireCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return MicroservicesArchitecture.diagram.edit.parts.Interface2EditPart.VISUAL_ID == MicroservicesArchitecture.diagram.part.MicroservicesArchitectureVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<MicroservicesArchitecture.diagram.part.MicroservicesArchitectureNodeDescriptor> childDescriptors = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramUpdater
				.getMicroServiceMicroServiceRequireCompartment_7002SemanticChildren((View) getHost().getModel());
