...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	...
	* @generated
	*/
	private MicroservicesArchitecture.diagram.part.DeleteElementAction deleteAction;
	...
	*/
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new MicroservicesArchitecture.diagram.part.DeleteElementAction(part);
		deleteAction.init();
	}
