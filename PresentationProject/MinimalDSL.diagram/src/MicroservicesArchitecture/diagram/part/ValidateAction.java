...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(MicroservicesArchitecture.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramEditorUtil
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		MicroservicesArchitecture.diagram.providers.MicroservicesArchitectureValidationProvider
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			MicroservicesArchitecture.diagram.providers.MicroservicesArchitectureMarkerNavigationProvider
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = MicroservicesArchitecture.diagram.part.MicroservicesArchitectureDiagramEditorUtil
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		MicroservicesArchitecture.diagram.providers.MicroservicesArchitectureMarkerNavigationProvider.addMarker(target,
