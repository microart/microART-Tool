...
/**
 * This is the item provider adapter for a {@link MicroservicesArchitecture.Cluster} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClusterItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cluster_contains_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cluster_contains_feature", "_UI_Cluster_type"),
				 MicroservicesArchitecturePackage.Literals.CLUSTER__CONTAINS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cluster_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cluster_context_feature", "_UI_Cluster_type"),
				 MicroservicesArchitecturePackage.Literals.CLUSTER__CONTEXT,
				 true,
				 false,
				 false,
