...
/**
 * This is the item provider adapter for a {@link MicroservicesArchitecture.Developer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeveloperItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicroservicesArchitecturePackage.Literals.DEVELOPER__EMAIL,
				 true,
				 false,
				 false,
	...
	protected void addUsernamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Developer_username_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Developer_username_feature", "_UI_Developer_type"),
				 MicroservicesArchitecturePackage.Literals.DEVELOPER__USERNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
