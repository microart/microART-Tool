...
/**
 * This is the item provider adapter for a {@link MicroservicesArchitecture.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_endPoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_endPoint_feature", "_UI_Interface_type"),
				 MicroservicesArchitecturePackage.Literals.INTERFACE__END_POINT,
				 true,
				 false,
				 false,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_port_feature", "_UI_Interface_type"),
				 MicroservicesArchitecturePackage.Literals.INTERFACE__PORT,
				 true,
				 false,
				 false,
